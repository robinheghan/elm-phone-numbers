...
countryCL =
    { id = "CL"
    , countryCode = "56"
    , internationalPrefix = Just "(?:0|1(?:1[0-69]|2[02-5]|5[13-58]|69|7[0167]|8[018]))0"
    , nationalPrefix = Nothing
    , generalNumberPattern =
...
countryCN =
    { id = "CN"
    , countryCode = "86"
    , internationalPrefix = Just "00|1(?:[12]\\d|79)\\d\\d00"
    , nationalPrefix = Just "0"
    , generalNumberPattern =
...
countryGB =
    ...
    , numberTypes =
        ...
        , { numberType = Pager
          ...
          , pattern =
                "76(?:0[0-2]|2[356]|34|4[01347]|5[49]|6[0-369]|77|81|9[39])\\d{6}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
...
countryHK =
    ...
    , numberTypes =
        [ { numberType = FixedLine
          , exampleNumber = "21234567"
          , pattern =
                "(?:384[0-5]|58(?:0[1-8]|1[2-9]))\\d{4}|(?:2(?:[13-9]\\d|2[013-9])|3(?:[1569][0-24-9]|4[0-246-9]|7[0-24-69]|89))\\d{5}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = Mobile
...
countryIL =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "5(?:(?:[02368]\\d|[19][2-9]|4[1-9])\\d|5(?:01|1[79]|2[2-8]|3[23]|44|5[05689]|6[6-8]|7[0-267]|8[7-9]|9[1-9]))\\d{5}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
...
countryIR =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "9(?:(?:0(?:[1-35]\\d|44)|(?:[13]\\d|2[0-2])\\d)\\d|9(?:(?:[0-2]\\d|4[45])\\d|5[15]0|8(?:1\\d|88)|9(?:0[013]|1[0134]|21|77|9[6-9])))\\d{5}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = Voip
...
countryKN =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "869(?:48[89]|5(?:5[6-8]|6[5-7])|66\\d|76[02-7])\\d{4}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
...
countryMM =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "(?:17[01]|9(?:2[0-4]|(?:3[0-36]|(?:6\\d|8[89]|98)\\d)\\d|4(?:[1379]\\d|88)|5[0-6])\\d)\\d{4}|9(?:[69]1|73)\\d{6}|9(?:[68]\\d|9[089])\\d{5}|9(?:2[56]|34|4[0245]|7[5-9]|9[4-7])\\d{7}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
...
countryMY =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          , exampleNumber = "123456789"
          , pattern =
                "1(?:4400|8(?:47|8[27])[0-4])\\d{4}|1(?:0(?:[23568]\\d|4[0-6]|7[016-9]|9[0-8])|1(?:[1-5]\\d\\d|6(?:0[5-9]|[1-9]\\d)|7(?:0\\d|1[01]|2[2-6]))|(?:(?:[269]|59)\\d|[37][1-9]|4[235-9])\\d|8(?:1[23]|[236]\\d|4[06]|5[7-9]|7[016-9]|8[01]|9[0-8]))\\d{5}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
...
countryNG =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "(?:702[0-24-9]|8(?:01|19)[01])\\d{6}|(?:70[13-689]|8(?:0[2-9]|1[0-8])|90[1-9])\\d{7}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
...
countryPG =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          , exampleNumber = "70123456"
          , pattern =
                "77(?:3[1-9]|[5-9]\\d)\\d{4}|(?:7[0-689]|81)\\d{6}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = Pager
...
countryPH =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "(?:81[37]|9(?:0[5-9]|1[0-24-9]|2[0-35-9]|[35]\\d|4[235-9]|6[0-25-8]|7[1-9]|8[189]|9[4-9]))\\d{7}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
...
countrySG =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          , exampleNumber = "81234567"
          , pattern =
                "(?:8(?:01[0-7]|[1-8]\\d\\d|9(?:[014]\\d|2[1-9]|3[0-489]|5[0-2]))|9[0-8]\\d\\d)\\d{4}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
...
countrySL =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "(?:25|3[013-5]|66|7[4-9]|8[08]|99)\\d{6}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        ]
...
countryVN =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          , exampleNumber = "912345678"
          , pattern =
                "(?:52[238]|89[689]|99[013-9])\\d{6}|(?:3\\d|5[689]|7[06-9]|8[1-8]|9[0-8])\\d{7}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
