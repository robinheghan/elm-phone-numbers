...
countryAZ =
    ...
    , numberTypes =
        [ { numberType = FixedLine
          ...
          , pattern =
                "365(?:[0-46-9]\\d|5[0-35-9])\\d{4}|(?:(?:1[28]|46)\\d|2(?:[045]2|1[24]|2[2-4]|33|6[23]))\\d{6}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = Mobile
          ...
          , pattern =
                "(?:36554|99[2-9]\\d\\d)\\d{4}|(?:[16]0|4[04]|5[015]|60|7[07])\\d{7}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
...
countryCL =
    ...
    , numberTypes =
        ...
        , { numberType = FixedLine
          ...
          , pattern =
                "(?:2(?:1962|3(?:2\\d\\d|3(?:00|23)))|80[1-9]\\d\\d)\\d{4}|(?:22|3[2-5]|[47][1-35]|5[1-3578]|6[13-57]|8[1-9]|9[2-9])\\d{7}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = Mobile
...
countryPW =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "(?:45[0-5]|6[2-4689]0|77\\d|88[0-4])\\d{4}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        ]
