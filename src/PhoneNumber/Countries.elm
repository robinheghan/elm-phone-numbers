...
countryAZ =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "(?:36554|99[2-9]\\d\\d)\\d{4}|(?:4[04]|5[015]|60|7[07])\\d{7}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
...
countryCA =
    ...
    , numberTypes =
        [ { numberType = FixedLine
          ...
          , pattern =
                "(?:2(?:04|[23]6|[48]9|50)|3(?:06|43|65)|4(?:03|1[68]|3[178]|50)|5(?:06|1[49]|48|79|8[17])|6(?:04|13|39|47|72)|7(?:0[59]|78|8[02])|8(?:[06]7|19|25|73)|90[25])[2-9]\\d{6}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = Mobile
...
countryHN =
    ...
    , numberTypes =
        ...
        , { numberType = FixedLine
          , exampleNumber = "22123456"
          , pattern =
                "2(?:2(?:0[019]|1[1-36]|[23]\\d|4[04-6]|5[57]|6[24]|7[0135689]|8[01346-9]|9[0-2])|4(?:07|2[3-59]|3[13-689]|4[0-68]|5[1-35])|5(?:0[78]|16|4[03-5]|5\\d|6[014-6]|74|80)|6(?:[056]\\d|17|2[07]|3[04]|4[0-378]|[78][0-8]|9[01])|7(?:6[46-9]|7[02-9]|8[034]|91)|8(?:79|8[0-357-9]|9[1-57-9]))\\d{4}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = Mobile
...
countryIL =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "5(?:(?:[0-389][2-9]|4[1-9]|6\\d)\\d|5(?:01|2[2-7]|3[23]|4[45]|5[05689]|6[6-8]|7[0-267]|8[7-9]|9[1-9]))\\d{5}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
...
countryJO =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "7(?:55[0-49]|(?:7[025-9]|8[0-25-9]|9\\d)\\d)\\d{5}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = Pager
...
countryKR =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "1(?:05(?:[0-8]\\d|9[0-5])|22[13]\\d)\\d{4,5}|1(?:0[1-46-9]|[16-9]\\d|2[013-9])\\d{6,7}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = Pager
...
countryMA =
    ...
    , numberTypes =
        [ { numberType = FixedLine
          ...
          , pattern =
                "5(?:29(?:[189]0|29)|38[89]0)\\d{4}|5(?:2(?:[015-7]\\d|2[02-9]|3[0-578]|4[2-46-8]|8[0235-7]|90)|3(?:[0-47]\\d|5[2-9]|6[02-8]|80|9[3-9])|(?:4[067]|5[03])\\d)\\d{5}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = Mobile
...
countryML =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "2(?:079|17\\d)\\d{4}|(?:5[01]|[679]\\d|8[239])\\d{6}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
...
countryMM =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "(?:17[01]|9(?:2(?:[0-4]|[56]\\d\\d)|(?:3(?:[0-36]|4\\d)|6(?:6[0-2]|[7-9]\\d)|7(?:3|[5-9]\\d)|8(?:8[4-9]|9\\d)|9[5-8]\\d)\\d|4(?:(?:[0245]\\d|[1379])\\d|88)|5[0-6])\\d)\\d{4}|9[69]1\\d{6}|9(?:[68]\\d|9[089])\\d{5}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
...
countryMY =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          , exampleNumber = "123456789"
          , pattern =
                "1(?:4400|8(?:47|8[27])[0-4])\\d{4}|1(?:0(?:[23568]\\d|4[0-6]|7[016-9]|9[0-8])|1(?:[1-5]\\d\\d|6(?:0[5-9]|[1-9]\\d)|7(?:0[3-9]|1[01]))|(?:[2379][2-9]|4[235-9]|(?:59|6)\\d)\\d|8(?:1[23]|[236]\\d|4[06]|5[7-9]|7[016-9]|8[01]|9[0-8]))\\d{5}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
...
countryNG =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "(?:707[0-3]|8(?:01|19)[01])\\d{6}|(?:70[1-689]|8(?:0[2-9]|1[0-8])|90[1-9])\\d{7}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
...
countryNZ =
    ...
    , nationalPrefix = Just "0"
    , generalNumberPattern =
        "2\\d{7,9}|(?:[34]\\d|6[0-35-9])\\d{6}|(?:508|[79]\\d)\\d{6,7}|8\\d{4,9}"
            |> Regex.fromString
            |> Maybe.withDefault Regex.never
    , numberTypes =
        [ { numberType = FixedLine
...
countryRE =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "(?:69(?:2\\d\\d|3(?:0[0-46]|1[013]|2[0-2]|3[0-39]|4\\d|5[05]|6[0-26]|7[0-27]|8[03-8]|9[0-479]))|9769\\d)\\d{4}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
...
countryRO =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "7120\\d{5}|7(?:[02-7]\\d|1[01]|8[03-8]|9[09])\\d{6}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
...
countrySG =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          , exampleNumber = "81234567"
          , pattern =
                "(?:8(?:[1-8]\\d\\d|9(?:[01]\\d|2[1-8]|3[0-4]))|9[0-8]\\d\\d)\\d{4}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
...
countryTT =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "868(?:2(?:6[346-9]|[7-9]\\d)|[37](?:0[1-9]|1[02-9]|[2-9]\\d)|4[6-9]\\d|6(?:20|78|8\\d))\\d{4}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
