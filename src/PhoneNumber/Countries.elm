...
countryCL =
    ...
    , numberTypes =
        ...
        , { numberType = FixedLine
          ...
          , pattern =
                "(?:2(?:1962|3(?:2\\d\\d|3(?:[034]0|23)))|80[1-9]\\d\\d)\\d{4}|(?:22|3[2-5]|[47][1-35]|5[1-3578]|6[13-57]|8[1-9]|9[2-9])\\d{7}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = Mobile
...
countryMN =
    ...
    , numberTypes =
        [ { numberType = FixedLine
          , exampleNumber = "50123456"
          , pattern =
                "[12]2[1-3]\\d{5,6}|70[0-5]\\d{5}|(?:[12](?:1|27)|5[03568])\\d{6}|[12](?:3[2-8]|4[2-68]|5[1-4689])\\d{6,7}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = Mobile
          ...
          , pattern =
                "(?:8(?:[05689]\\d|3[01])|9(?:[013-9]\\d|20))\\d{5}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = Voip
...
countryTT =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "868(?:2(?:6[3-9]|[7-9]\\d)|[37](?:0[1-9]|1[02-9]|[2-9]\\d)|4[6-9]\\d|6(?:20|78|8\\d))\\d{4}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
