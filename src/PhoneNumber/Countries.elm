...
countryHN =
    ...
    , numberTypes =
        ...
        , { numberType = FixedLine
          , exampleNumber = "22123456"
          , pattern =
                "2(?:2(?:0[0139]|1[1-36]|[23]\\d|4[04-6]|5[57]|6[24]|7[0135689]|8[01346-9]|9[0-2])|4(?:07|2[3-59]|3[13-689]|4[0-68]|5[1-35])|5(?:0[7-9]|16|4[03-5]|5\\d|6[014-6]|74|80)|6(?:[056]\\d|17|2[07]|3[04]|4[0-378]|[78][0-8]|9[01])|7(?:6[46-9]|7[02-9]|8[034]|91)|8(?:79|8[0-357-9]|9[1-57-9]))\\d{4}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = Mobile
...
countryTJ =
    ...
    , numberTypes =
        ...
        , { numberType = Mobile
          ...
          , pattern =
                "41[18]\\d{6}|(?:[04]0|11|5[05]|7[07]|88|9\\d)\\d{7}"
                    |> Regex.fromString
                    |> Maybe.withDefault Regex.never
          }
        , { numberType = TollFree
